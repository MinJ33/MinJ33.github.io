---
layout: post
title: "[Coursera] Foundations of User Experience (UX) Design 1-2"
subtitle: "Module 2: Thinking like a UX designer"
...
- As a refresher, a platform is the medium that users experience your product on. Some common platforms are:
	- Desktop computers
	- Laptop computers
	- Mobile phones
	- Tablets
...
- Key considerations when designing for different platforms
	- Screen size: You have to carefully decide which parts of the design you'll prioritize including in the limited space
	- Interaction: In addition to the size of the screen, you also need to consider the way users interact with each platform and how those interactions might affect your design decisions. 
	- Content layout: Consider the layout of content on a couple more platforms: tablets combine both the desktop and mobile phone user experience, which means you can incorporate aspects of desktop and mobile phone content layouts in your designs
	- Functionality: There are a lot of reasons why users might choose one platform over another, but functionality and the kind of tasks they want to complete is a huge driver.
